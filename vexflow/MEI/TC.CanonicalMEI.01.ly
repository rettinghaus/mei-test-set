...
mdivA_staffC = {
  \set Staff.clefGlyph = #"clefs.G" \set Staff.clefPosition = #-2 \set Staff.clefTransposition = #0 \set Staff.middleCPosition = #-6 \set Staff.middleCClefPosition = #-6 \key c\major
  \time 4/2 
  << { e'2 e'2 e'2 e'\longa } >> \bar "|." %1
}

mdivA_staffD = {
  \set Staff.clefGlyph = #"clefs.G" \set Staff.clefPosition = #-2 \set Staff.clefTransposition = #-7 \set Staff.middleCPosition = #1 \set Staff.middleCClefPosition = #1 \key c\major
  \time 4/2 
  << { e'4 g'4 e'4 g'4 e'4 g'4 e'4 g'\longa } >> \bar "|." %1
}
...
mdivA_staffG = {
  ...
  \time 4/2 
  << { c2 c2 c2 c\longa \tag #'Source-A { \tweak color #(rgb-color 1 0 0) \tweak Stem.color #(rgb-color 1 0 0) c'2 \tweak color #(rgb-color 1 0 0) \tweak Stem.color #(rgb-color 1 0 0) c'\longa } } >> \bar "|." %1
}
