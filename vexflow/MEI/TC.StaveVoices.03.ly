...
\new StaffGroup <<
 ...
 \tweak TimeSignature.style #'numbered \time 4/4 \set Score.currentBarNumber = #2 \mdivA_staffA }
 \new Staff = "staff 2" {
 \autoBeamOff \set tieWaitForNote = ##t
 \tweak TimeSignature.style #'numbered \time 4/4 \set Score.currentBarNumber = #2 \mdivA_staffB }
>>
>>
\layout {
}
