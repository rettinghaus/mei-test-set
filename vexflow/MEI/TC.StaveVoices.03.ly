...
\new StaffGroup <<
 ...
 \tweak TimeSignature.style #'numbered \time 4/4 \override Staff.BarLine.allow-span-bar = ##f \set Score.currentBarNumber = #2 \mdivA_staffA }
 \new Staff = "staff 2" {
 \set Staff.autoBeaming = ##f 
    \set tieWaitForNote = ##t
 \tweak TimeSignature.style #'numbered \time 4/4 \override Staff.BarLine.allow-span-bar = ##f \set Score.currentBarNumber = #2 \mdivA_staffB }
>>
>>
\layout {
}
