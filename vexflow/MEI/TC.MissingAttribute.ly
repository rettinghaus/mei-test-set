...
mdivA_staffA = {
  ...
  << { a'1 e'2 a'2 g'2 r4 a'4 a'4 g'4 a'2 e'4 b'4 c''2 } >> %1
}
...
mdivA_staffB = {
  \set Staff.clefGlyph = #"clefs.G" \set Staff.clefPosition = #-2 \set Staff.clefTransposition = #-7 \set Staff.middleCPosition = #1 \set Staff.middleCClefPosition = #1 \key c \major   \tweak TimeSignature.style #'numbered \time 4/4 
  << { a1 c'2 d'2 e'4. d'8 c'4 b8 a8 b2 a4 e'2 } >> %1
}
...
mdivA_staffC = {
  \set Staff.clefGlyph = #"clefs.G" \set Staff.clefPosition = #2 \set Staff.clefTransposition = #-7 \set Staff.middleCPosition = #5 \set Staff.middleCClefPosition = #5 \key c \major   \tweak TimeSignature.style #'numbered \time 4/4 
  << { r1 } >> %1
}
