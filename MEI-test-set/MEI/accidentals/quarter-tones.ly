...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #DOWN c''4 \tweak Stem.direction #DOWN cis''!4 \tweak Stem.direction #DOWN cis''4 \tweak Stem.direction #DOWN d''!4 } >> %1
  << { \tweak Stem.direction #DOWN d''4 \tweak Stem.direction #DOWN cis''!4 \tweak Stem.direction #DOWN cis''4 \tweak Stem.direction #DOWN cis''4 } >> \bar "|." %2
}
