...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP dis''!4 \tweak Stem.direction #UP b'!4 \tweak Stem.direction #UP aes'!2 } \\ { \tweak Stem.direction #DOWN d''!4 \tweak Stem.direction #DOWN bes'!4 \tweak Stem.direction #DOWN a'!2 } >> \bar "|." %1
}
