...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #DOWN bes'!4 \tweak Stem.direction #DOWN b'!4 \tweak Stem.direction #UP gis'!4 \tweak Stem.direction #UP g'!4 } >> %1
  << { \tweak Stem.direction #DOWN beses'!4 \tweak Stem.direction #DOWN bes'!4 \tweak Stem.direction #UP gisis'!4 \tweak Stem.direction #UP gis'!4 } >> \bar "|." %2
}
