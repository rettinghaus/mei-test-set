...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #DOWN cis''!2. \tweak Stem.direction #DOWN cis''!4-~ } >> %1
  << { \tweak Stem.direction #DOWN cis''!2. \tweak Stem.direction #DOWN cis''!4 } >> %2
  << { \tweak Stem.direction #DOWN cis''!2. \tweak Stem.direction #DOWN cis''!4-~ } >> %3
  << { \tweak Stem.direction #DOWN cis''!2. \tweak Stem.direction #DOWN c''!4 } >> \bar "|." %4
}
