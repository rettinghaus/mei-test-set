...
mdivA_staffA = {
  ...
  << { r8 \tweak Stem.direction #UP b'8-~ \tweak Stem.direction #UP b'2 < \tweak Stem.direction #DOWN e'-~ g'-~ b'-~ d''-~ f''-~ >4 } \\ { s8 \tweak Stem.direction #DOWN g'8-~ \tweak Stem.direction #DOWN g'2 s4 } >> %1
  << { < \tweak Stem.direction #DOWN e' g' b' d'' f'' >4 r4 r2 } >> \bar "|." %2
}
