...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP e'4 \tweak Stem.direction #DOWN c''4 \tweak Stem.direction #UP a'4 \tweak Stem.direction #DOWN b'4 } >> %1
  << { \tweak Stem.direction #DOWN d''2-~ \tweak Stem.direction #UP d''8[ \tweak Stem.direction #UP g'8 \tweak Stem.direction #UP a'8 \tweak Stem.direction #UP b'8] } >> \bar "|." %2
}
