...
mdivA_staffA = {
  ...
  << { < \tweak Stem.direction #UP f'-~ c''-~ >4 < \tweak Stem.direction #UP f' c'' >4 < \tweak Stem.direction #UP e'-~ g'-~ d''-~ >4 < \tweak Stem.direction #UP e' g' d'' >4 } >> %1
  << { < \tweak Stem.direction #DOWN e'-~ c''-~ e''-~ >4 < \tweak Stem.direction #DOWN e' c'' e'' >4 < \tweak Stem.direction #DOWN f'-~ a'-~ d''-~ f''-~ >4 < \tweak Stem.direction #DOWN f' a' d'' f'' >4 } >> \bar "|." %2
}
