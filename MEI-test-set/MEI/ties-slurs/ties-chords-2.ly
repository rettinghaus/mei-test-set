...
mdivA_staffA = {
  ...
  << { < \tweak Stem.direction #UP e'-~ f'-~ c''-~ d''-~ >4 < \tweak Stem.direction #UP e' f' c'' d'' >4 < \tweak Stem.direction #UP d'-~ e'-~ g'-~ b'-~ d''-~ f''-~ >4 < \tweak Stem.direction #UP d' e' g' b' d'' f'' >4 } >> %1
  << { < \tweak Stem.direction #UP g'-~ a'-~ b'-~ c''-~ >4 < \tweak Stem.direction #UP g' a' b' c'' >4 < \tweak Stem.direction #UP g'-~ b'-~ c''-~ >4 < \tweak Stem.direction #UP g' b' c'' >4 } >> \bar "|." %2
}
