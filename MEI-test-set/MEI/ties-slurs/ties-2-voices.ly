...
mdivA_staffA = {
  ...
  << { < \tweak Stem.direction #UP c''-~ e''-~ >4 < \tweak Stem.direction #UP c'' e'' >8[ < \tweak Stem.direction #UP c''-~ a''-~ >8] < \tweak Stem.direction #UP c'' a'' >8 r8 r4 } \\ { < \tweak Stem.direction #DOWN c'-~ e'-~ >4 < \tweak Stem.direction #DOWN c' e' >8[ < \tweak Stem.direction #DOWN a-~ e'-~ >8] < \tweak Stem.direction #DOWN a e' >8 r8 r4 } >> \bar "|." %1
}
