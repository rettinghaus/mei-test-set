...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP e'8[ \tweak Stem.direction #UP f'8] \tweak Stem.direction #DOWN d''4 \tweak Stem.direction #DOWN c''4 \tweak Stem.direction #UP a'4-~ } >> %1
  << { \tweak Stem.direction #UP a'4 r4 r2 } >> \bar "|." %2
}
