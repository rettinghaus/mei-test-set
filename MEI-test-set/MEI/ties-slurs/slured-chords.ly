...
mdivA_staffA = {
  ...
  << { < \tweak Stem.direction #UP f' g' >2 < \tweak Stem.direction #DOWN b' c'' >2 } >> %1
  << { < \tweak Stem.direction #DOWN b' d'' >4 < \tweak Stem.direction #UP e' g' >4 < \tweak Stem.direction #UP f' b' >4 < \tweak Stem.direction #DOWN d'' f'' >4 } >> \bar "|." %2
}
