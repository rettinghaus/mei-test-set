...
mdivA_staffA = {
  ...
  \time 3/4 
  << { \tweak Stem.direction #UP e''2.-~ } \\ { \tweak Stem.direction #DOWN c''2.-~ } >> %1
  << { \tweak Stem.direction #UP e''4 \tweak Stem.direction #UP e'4 \tweak Stem.direction #UP g'4-~ } \\ { \tweak Stem.direction #DOWN c''2.-~ } >> %2
  << { \tweak Stem.direction #UP g'4 r4 r4 } \\ { \tweak Stem.direction #DOWN c''2. } >> \bar "|." %3
}
