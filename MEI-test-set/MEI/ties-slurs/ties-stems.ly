...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP g'4-~ \tweak Stem.direction #DOWN g'8[ \tweak Stem.direction #DOWN e''8] \tweak Stem.direction #UP f''4-~ \tweak Stem.direction #UP f''8 r8 } \\ { s2 \tweak Stem.direction #DOWN g'4-~ \tweak Stem.direction #DOWN g'8 s8 } >> \bar "|." %1
}
