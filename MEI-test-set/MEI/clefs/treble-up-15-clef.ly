...
mdivA_staffA = {
  \set Staff.clefGlyph = #"clefs.G" \set Staff.clefPosition = #-2 \set Staff.clefTransposition = #14 \set Staff.middleCPosition = #-20 \set Staff.middleCClefPosition = #-20 \key c\major
  \tweak TimeSignature.style #'numbered \time 4/4 
  << { \tweak Stem.direction #UP g'1 } >> \bar "|." %1
}
