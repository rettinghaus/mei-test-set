...
mdivA_staffA = {
  \set Staff.clefGlyph = #"clefs.G" \set Staff.clefPosition = #-2 \set Staff.clefTransposition = #7 \set Staff.middleCPosition = #-13 \set Staff.middleCClefPosition = #-13 \key c\major
