...
mdivA_staffA = {
  \set Staff.clefGlyph = #"clefs.F" \set Staff.clefPosition = #4 \set Staff.clefTransposition = #0 \set Staff.middleCPosition = #8 \set Staff.middleCClefPosition = #8 \key c\major
