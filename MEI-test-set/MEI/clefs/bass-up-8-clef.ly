...
mdivA_staffA = {
  \set Staff.clefGlyph = #"clefs.F" \set Staff.clefPosition = #2 \set Staff.clefTransposition = #7 \set Staff.middleCPosition = #-1 \set Staff.middleCClefPosition = #-1 \key c\major
