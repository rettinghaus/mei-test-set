...
mdivA_staffA = {
  \set Staff.clefGlyph = #"clefs.F" \set Staff.clefPosition = #2 \set Staff.clefTransposition = #-7 \set Staff.middleCPosition = #13 \set Staff.middleCClefPosition = #13 \key c\major
  \tweak TimeSignature.style #'numbered \time 4/4 
  << { \tweak Stem.direction #DOWN g1 } >> \bar "|." %1
}
