...
mdivA_staffA = {
  \set Staff.clefGlyph = #"clefs.F" \set Staff.clefPosition = #2 \set Staff.clefTransposition = #14 \set Staff.middleCPosition = #-8 \set Staff.middleCClefPosition = #-8 \key c\major
