...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #DOWN f''2 \tweak Stem.direction #DOWN d'''8 r8 r4 } >> %1
  << { < \tweak Stem.direction #DOWN e' b' d'' >8[ < \tweak Stem.direction #DOWN f' c'' e'' >8 < \tweak Stem.direction #DOWN a' e'' a'' >8 < \tweak Stem.direction #DOWN e' a' e'' >8] r2 } >> \bar "|." %2
}
