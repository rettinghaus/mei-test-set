...
mdivA_staffA = {
  ...
  << { r4 \tweak Stem.direction #UP g'4 \tweak Stem.direction #DOWN b'4 \tweak Stem.direction #DOWN c''4 } >> %1
  \bar ".|:" << { \tweak Stem.direction #DOWN d''2 r2 } >> %2
  << { r4 \tweak Stem.direction #UP g'4 \tweak Stem.direction #DOWN b'4 \tweak Stem.direction #DOWN c''4 } >> %3
  << { \tweak Stem.direction #DOWN d''2 \tweak Stem.direction #DOWN b'2 } >> %4
  << { \tweak Stem.direction #UP g'2 \tweak Stem.direction #DOWN b'2 } >> \bar ":|." %5
}
