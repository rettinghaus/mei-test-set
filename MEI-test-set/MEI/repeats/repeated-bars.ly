...
mdivA_staffA = {
  ...
  \time 6/8 
  << { < \tweak Stem.direction #DOWN g' b' >8[ < \tweak Stem.direction #DOWN a' c'' >8 < \tweak Stem.direction #DOWN b' d'' >8] < \tweak Stem.direction #DOWN b' d'' >8[ < \tweak Stem.direction #DOWN a' c'' >8 < \tweak Stem.direction #DOWN g' b' >8] } >> %1
  << { } >> %2
  << { } >> %3
  << { } >> %4
  << { } >> %5
