...
mdivA_staffA = {
  ...
  \bar ".|:" << { \tweak Stem.direction #UP f'2 \tweak Stem.direction #UP f'8 \tweak Stem.direction #UP f'8[ \tweak Stem.direction #UP f'8 \tweak Stem.direction #UP f'8] } >> %1
  << { \tweak Stem.direction #UP f'1 } >> %2
  << { \tweak Stem.direction #UP f'2-~ \tweak Stem.direction #UP f'8 r8 \tweak Stem.direction #UP f'4 } >> \bar ":|." %3
  << { \tweak Stem.direction #UP f'1 } >> \bar "|." %4
}
