...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP e'32[ \tweak Stem.direction #UP f'32 \tweak Stem.direction #UP g'32 \tweak Stem.direction #UP a'32 \tweak Stem.direction #UP b'32 \tweak Stem.direction #UP c''32 \tweak Stem.direction #UP d''32 \tweak Stem.direction #UP e''32] \tweak Stem.direction #DOWN f''32 r32 r16 r8 r2 } >> \bar "|." %1
}
