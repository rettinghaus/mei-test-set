...
mdivA_staffA = {
  ...
  << { < \tweak Stem.direction #UP f' g' >1 } \\ { s1 } >> %1
  << { < \tweak Stem.direction #DOWN b' c'' d'' >1 } >> %2
  << { < \tweak Stem.direction #UP g' a' >1 } \\ { < \tweak Stem.direction #DOWN e' f' >1 } >> %3
  << { < \tweak Stem.direction #UP g' a' b' >1 } \\ { < \tweak Stem.direction #DOWN d' e' f' >1 } >> \bar "|." %4
}
