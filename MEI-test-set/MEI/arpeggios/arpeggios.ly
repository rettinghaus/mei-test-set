...
mdivA_staffA = {
  ...
  << { < \tweak Stem.direction #UP d' f' c'' e'' >2 < \tweak Stem.direction #UP dis'! fis'! cis''! eis''! >2 } >> %1
  << { < \tweak Stem.direction #UP d'! f'! c''! e''! >2 < \tweak Stem.direction #UP dis'! fis'! cis''! eis''! >2 } >> %2
  << { < \tweak Stem.direction #UP d'! f'! c''! e''! >2 < \tweak Stem.direction #UP dis'! fis'! cis''! eis''! >2 } >> \bar "|." %3
}
