...
mdivA_staffA = {
  ...
  << { < \tweak Stem.direction #UP d' g' b' >2 < \tweak Stem.direction #UP d' g' b' >2 } >> %1
  << { < \tweak Stem.direction #UP d' g' b' >2 < \tweak Stem.direction #UP d' g' b' >2 } >> %2
  << { < \tweak Stem.direction #UP d' g' b' >2 r2 } >> %3
  << { < \tweak Stem.direction #UP d' d'' >2 < \tweak Stem.direction #UP e' g' d'' >2 } >> %4
  << { < \tweak Stem.direction #UP d' g' b' >2 < \tweak Stem.direction #UP f' b' d'' >4 < \tweak Stem.direction #DOWN f' b' f'' >4 } >> \bar "|." %5
}
...
mdivA_staffB = {
  ...
  \tweak TimeSignature.style #'numbered \time 4/4 
  << { < \tweak Stem.direction #DOWN g, d b >2 < \tweak Stem.direction #DOWN g, d b >2 } >> %1
  << { < \tweak Stem.direction #DOWN g, d b >2 < \tweak Stem.direction #DOWN g, d b >2 } >> %2
  << { < \tweak Stem.direction #DOWN g, d b >2 r2 } >> %3
  << { < \tweak Stem.direction #DOWN d b >2 < \tweak Stem.direction #DOWN a, f b >2 } >> %4
  << { < \tweak Stem.direction #DOWN g, d b >2 < \tweak Stem.direction #DOWN g, b, f b >2 } >> \bar "|." %5
}
