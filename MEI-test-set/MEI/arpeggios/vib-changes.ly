...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP a'2\bendAfter #2  \tweak Stem.direction #DOWN b'2\bendAfter #-2  } >> %1
  << { \tweak Stem.direction #UP g'1-~ } >> %2
  << { \tweak Stem.direction #UP g'1-~ } >> %3
  << { \tweak Stem.direction #UP g'1-~ } >> %4
  << { \tweak Stem.direction #UP g'1 } >> \bar "|." %5
}
