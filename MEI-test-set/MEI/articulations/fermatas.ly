...
mdivA_staffA = {
  ...
  << { R4*4-\fermataMarkup } >> %1
  << { R4*4-\shortfermataMarkup } >> %2
  << { R4*4-\longfermataMarkup } >> %3
  << { \tweak Stem.direction #UP g'4-\fermata \tweak Stem.direction #UP g'4-\shortfermata \tweak Stem.direction #UP g'4-\longfermata r4-\shortfermata } >> \bar "|." %4
}
