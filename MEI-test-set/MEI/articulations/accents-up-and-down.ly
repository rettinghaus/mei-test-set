...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP e'4\accent \tweak Stem.direction #UP f'4\accent \tweak Stem.direction #UP g'4\accent \tweak Stem.direction #DOWN d''4\accent } >> %1
  << { \tweak Stem.direction #DOWN c''4\accent \tweak Stem.direction #DOWN b'4\accent \tweak Stem.direction #UP e'4\accent \tweak Stem.direction #DOWN b'4\accent } >> \bar "|." %2
}
