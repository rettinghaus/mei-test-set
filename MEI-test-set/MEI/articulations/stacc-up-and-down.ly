...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP e'4\staccato \tweak Stem.direction #UP f'4\staccato \tweak Stem.direction #UP g'4 \tweak Stem.direction #DOWN d''4\staccato } >> %1
  << { \tweak Stem.direction #DOWN c''4\staccato \tweak Stem.direction #DOWN b'4\staccato \tweak Stem.direction #UP e'4 \tweak Stem.direction #DOWN b'4\staccato } >> \bar "|." %2
}
