...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP g'8[\staccato \tweak Stem.direction #UP g'8\staccato \tweak Stem.direction #UP g'8\staccato \tweak Stem.direction #UP g'8]\staccato-\tweak extra-offset #'(0 . 0) \trill \tweak Stem.direction #UP g'2-\tweak extra-offset #'(0 . 0) \trill } >> \bar "|." %1
}
