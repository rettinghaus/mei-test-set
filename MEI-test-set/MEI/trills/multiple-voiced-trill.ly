...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP a''2-\tweak extra-offset #'(0 . 0) \trill \tweak Stem.direction #UP g''2 } \\ { \tweak Stem.direction #DOWN e'2\trill \tweak Stem.direction #DOWN g'2 } >> %1
  << { \tweak Stem.direction #UP f''2 \tweak Stem.direction #UP e''2 } \\ { \tweak Stem.direction #DOWN f'2\trill \tweak Stem.direction #DOWN e'2 } >> %2
  << { < \tweak Stem.direction #UP b' f'' >2 r2 } \\ { \tweak Stem.direction #DOWN e'2 r2 } >> \bar "|." %3
}
