...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP e'2-\tweak extra-offset #'(0 . 0) \trill \tweak Stem.direction #DOWN ees''!2 } >> %1
  << { \tweak Stem.direction #DOWN b'2 \tweak Stem.direction #UP g'2 } >> %2
  << { \tweak Stem.direction #UP a'2 \tweak Stem.direction #UP f'2 } >> \bar "|." %3
}
