...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP a'4 \tweak Stem.direction #UP a'4 \tweak Stem.direction #DOWN b'4 \tweak Stem.direction #DOWN c''4 } >> %1
  << { \tweak Stem.direction #DOWN c''4 \tweak Stem.direction #DOWN b'4 \tweak Stem.direction #UP a'4 \tweak Stem.direction #UP g'4 } >> \bar "|." %2
}
