...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP e'4 \tweak Stem.direction #UP f'4 \tweak Stem.direction #UP g'4 \tweak Stem.direction #UP a4-~ } >> %1
  << { \tweak Stem.direction #UP a8[ \tweak Stem.direction #UP b8] \tweak Stem.direction #UP c'2 r4 } >> \bar "|." %2
}
