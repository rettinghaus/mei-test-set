...
mdivA_staffA = {
  ...
  \time 9/8 
  \set Timing.measurePosition = #(ly:make-moment -3/8) << { r8 \tweak Stem.direction #UP f'8[ \tweak Stem.direction #UP f'8] } >> %1
  << { \tweak Stem.direction #UP f'8[ \tweak Stem.direction #UP f'8 \tweak Stem.direction #UP f'8] \tweak Stem.direction #UP f'8 r8 r8 r8 \tweak Stem.direction #UP f'8[ \tweak Stem.direction #UP f'8] } >> \bar "|." %2
}
