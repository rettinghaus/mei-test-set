...
mdivA_staffA = {
  ...
  << { < \tweak Stem.direction #UP g' c'' e'' >8[ < \tweak Stem.direction #UP a' c'' f'' >8] \tweak Stem.direction #UP g''2. } \\ { \tweak Stem.direction #DOWN c'4 < \tweak Stem.direction #DOWN g' b' >4 < \tweak Stem.direction #DOWN f' a' >4 < \tweak Stem.direction #DOWN e' g' >4 } >> \bar "|." %1
}
