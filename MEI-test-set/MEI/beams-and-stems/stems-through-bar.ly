...
mdivA_staffA = {
  ...
  \time 2/4 
  << { \tweak Stem.direction #UP a'32[ \tweak Stem.direction #UP a'32 \tweak Stem.direction #UP a'32 \tweak Stem.direction #UP a'32 \tweak Stem.direction #UP a'16. \tweak Stem.direction #UP a'32] r4 } >> \bar "|." %1
}
