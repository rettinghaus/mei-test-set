...
mdivA_staffA = {
  ...
  << { \tweak Stem.direction #UP g2 \tweak Stem.direction #UP g4 \tweak Stem.direction #UP g8[ \tweak Stem.direction #UP g8] } >> %1
  << { \tweak Stem.direction #UP g8[ \tweak Stem.direction #UP g8] \tweak Stem.direction #UP g4 \tweak Stem.direction #UP g2 } >> \bar "|." %2
}
